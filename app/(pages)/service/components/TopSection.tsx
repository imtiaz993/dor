  ...
  return (
    <div className="pt-[140px]">
      <div className="container">
        <p className="text-xl text-[#ACACAC] text-center">
          Have a query? Looking for solutions?
        </p>
        <h1 className="font-semibold text-[30px] sm:text-6xl lg:text-[64px] xl:text-7xl mt-2 mb-10 text-[#F7F7F7] text-center">
